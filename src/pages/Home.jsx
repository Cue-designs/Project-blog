   ...
   <main className="mt-10 mx-4 lg:mx-4 bg-black md:mx-3 sm:mx-2">
     <ScrollFadeIn>
       <section className=" lg:ml-16 xl:ml-20">
        <h2 className="text-3xl sm:text-xl ml-2  md:text-2xl ml-4 lg:text-3xl  w-full leading-tight tracking-wider text-yellow-50  ">Start your coding jornery: Exploring the Programming</h2>
      ...
      <section>
        <div className="mb-8 lg:mb-12 xl:mb-12 p-6 lg:p-10 xl:p-12">
          <RightAnimationForward><h2 className="text-2xl lg:text-2xl xl:text-3xl mb-4 lg:mb-6 text-yellow-50">Get in touch</h2>
      ...
      <ScrollFadeIn><article className="bg-white text-black-400">
